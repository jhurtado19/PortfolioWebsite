    ...
    <Jumbotron id="aboutme" className="m-0">
      <div className="container row">
        ...
        <div className={`col-lg-${showPic ? "7" : "12"}`}>
          ...
          <p className="lead text-center">  See my photography <a  href="https://jessehurtado.myportfolio.com/welcome" target="_blank" rel="noopener noreferrer"> portfolio.</a> See my projects!</p>
          {resume && (
