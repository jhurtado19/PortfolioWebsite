    ...
    <Jumbotron id="aboutme" className="m-0">
      <div className="container row">
        ...
        <div className={`col-lg-${showPic ? "7" : "12"}`}>
          ...
          <p className="lead text-center">  I graduated from the University of California, Los Angeles in 2023 with a Bachelors of Science degree in Neuroscience, and I am currently pursing a Masters Degree in Big Data Analytics at San Diego State University, where I am focused primarily on signal processing, regression analysis and time series forecasting models. My undergraduate work centered around visualizing neural data and simulating neurons to better understand their dynamics.</p>
          {resume && (
